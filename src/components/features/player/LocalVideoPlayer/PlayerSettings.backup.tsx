...
interface PlayerSettingsProps {
  ...
  selectedServer: 'vidlink-pro' | 'vidlink-me' | 'universal';
  handleServerChange: (serverId: 'vidlink-pro' | 'vidlink-me' | 'universal') => Promise<void>;
                ...
                <>
                  ...
                  <div className="server-cards-grid" style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    {[
                      ...
                      { id: 'vidlink-me', name: 'Vidlink Me', description: 'Alternative gateway — vidlink.me', badge: 'Gateway' },
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '8px' }}>
                    ...
                    <span style={{ color: '#fff', fontSize: '0.8rem', fontWeight: 700 }}>
                      {selectedServer === 'vidlink-pro' ? 'Vidlink Pro' : selectedServer === 'vidlink-me' ? 'Vidlink Me' : 'Universal Player'}
                    </span>
                  </div>
