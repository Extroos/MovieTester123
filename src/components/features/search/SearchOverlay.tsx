...
import { searchMulti, getPosterUrl, getBackdropUrl, getTrendingByGenre, getDiscoverNetflix, getDiscoverDisney, getDiscoverOscars, getTrending, getUpcoming } from '../../../services/tmdb';
...
const headerOffset = showFilters ? 146 : 92;
  ...
  const [trendingBackdrop, setTrendingBackdrop] = useState<string>('/backdrop-placeholder.png');
  const [newBackdrop, setNewBackdrop] = useState<string>('/backdrop-placeholder.png');
