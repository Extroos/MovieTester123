...
const CastSection = React.memo(function CastSection({ cast, onActorClick }: CastSectionProps) {
  if (!cast || cast.length === 0) return null;

  return (
    <div style={{ marginBottom: '1.2rem' }}>
      <h3 style={{ fontSize: '1.2rem', fontWeight: 600, marginBottom: '0.8rem', color: '#e5e5e5' }}>Cast</h3>
      <div style={{ 
         display: 'flex', 
         flexWrap: 'nowrap', 
         gap: '20px',
         ...
         {cast.slice(0, 20).map(person => (
           <div 
            ...
            >
               <div 
                 className="cast-actor-avatar-container"
                 style={{
                    width: '100%',
                    aspectRatio: '1/1',
                    borderRadius: '20px',
